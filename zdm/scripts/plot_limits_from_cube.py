...
def main(verbose=False):
    ...
    ac.do_single_plots(uvals,uw_vectors,None,data["params"],tag="",log=False,logspline=False,kind='linear',truth=None,dolevels=True,latexnames=latexnames)
    ...
    ac.do_single_plots(uvals,wH0_vectors,None,data["params"],tag="wH0_",truth=None,
    ...
    ac.do_single_plots(uvals,wH0_vectors,None,data["params"],tag="wH0_others_",truth=None,
    ...
    for which,array in enumerate(arrays):
        ...
        if False and data["params"][i]=="H0":
            savename="normed2D/lls_"+data["params"][j]+"_"+data["params"][i]+".png"
