...
def initialise_Magni(opdir,clusterRedshift, name, clusterNeFile, trueClusterRedshift, sourceMagniArr=False):

    # in case you wish to switch to another output directory
    #opdir = "Localised_FRBs/"
    formatted_cluster_redshift = "{:03.2f}".format(clusterRedshift)
    opdir = opdir+"/"+name+'/z'+formatted_cluster_redshift+'/'
    print(opdir)
...
def initialise_DM_Scattering(opdir, clusterRedshift, name, clusterNeFile, trueClusterRedshift, energyIndex, sourceMagniArr=False):

    # in case you wish to switch to another output directory
    #opdir = "Localised_FRBs/"
    formatted_cluster_redshift = "{:03.2f}".format(clusterRedshift)
    formatted_energy_index = "{:03.2f}".format(energyIndex)
