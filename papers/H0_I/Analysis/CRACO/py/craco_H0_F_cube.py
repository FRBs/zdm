""" Cube for CRACO H0 vs. F degeneracy """
...
def main(pargs, outdir='Cubes/'):
    ...
    ############## Load up ##############
    pfile = pargs.pfile if pargs.pfile is not None else 'Cubes/craco_H0_F_cube.json'
...
'''
# Test
python py/craco_H0_F_cube.py -n 1 -m 100 -o tmp.out --clobber
