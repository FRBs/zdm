""" 
This script prints out a physically meaningful value
of the constant number of FRBS in a range of systematic
survey sets.
...
def main():
    ...
    psets.insert(0,st.shin_fit())
    psets.insert(1,st.james_fit())
    ...
    for i,state in enumerate(states):
        ...
        print(i,"Number above Eref is ",meaningful,np.log10(meaningful))
        ...
        with open("changing_constants.txt", "a") as myfile:
            myfile.write(str(i)+"   "+str(newC)+"   "+str(oldC)+"   "+str(meaningful)+"   "+str(np.log10(meaningful))+"\n")
